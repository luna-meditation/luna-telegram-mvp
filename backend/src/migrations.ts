...
export async function runMigrations() {
  ...
  try {
    ...
    console.log('[Database migration] Premium product refinement applied', {
      migration: '20260718103933_premium_product_refinement',
      tables: ['support_requests', 'reminder_deliveries']
    });
