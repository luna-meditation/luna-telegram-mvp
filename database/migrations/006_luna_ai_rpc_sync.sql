-- Production RPC synchronization for the backend Luna quota reservation contract.
-- Additive and safe for existing conversations, messages, usage, and user state.
